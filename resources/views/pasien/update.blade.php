                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($patient->no_rm == 'Belum Ada')
                                                <input id="noberobat" name="noberobat" type="text"
                                                    ...
                                                    id="exampleInputName1" placeholder="No RM" value="{{ $norm }}">
                                                @error('noberobat')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="nama" name="nama" type="text"
                                            ...
                                            placeholder="Nama Lengkap" value="{{ $patient->nama_pasien }}">
                                        @error('nama')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="jeniskelamin" id="" value>
                                                <option value="{{ $patient->jenis_kelamin }}">
                                                    {{ $patient->jenis_kelamin }}</option>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input id="nik" name="nik" type="text"
                                                ...
                                                id="exampleInputName1" placeholder="NIK" value="{{ $patient->nik }}">
                                            @error('nik')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input id="pendidikan" name="pendidikan" type="text"
                                                ...
                                                id="exampleInputName1" placeholder="Pendidikan"
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input id="pekerjaan" name="pekerjaan" type="text"
                                                ...
                                                id="exampleInputName1" placeholder="Pekerjaan"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <textarea id="alamat" name="alamat" type="text" class="form-control @error('alamat') is-invalid @enderror"
                                                id="exampleInputName1" placeholder="Masukkan alamat">{{ $patient->alamat }}</textarea>
                                            @error('alamat')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
