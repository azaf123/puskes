...
<div class="container">
  ...
  <table class="table">
    ...
    <tbody>
      ...
      <td>{{ $getdata->category->ruangan}}</td>
        ...
        <div>
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
              <tr>
                <td class="col-md-9">Antrean</td>
                <td class="col-md-3"><i class="fa fa-inr"></i>{{ $getdata->antrean->no_antrean}}</td>
              </tr>
              <tr>
                <td class="col-md-9">Poli</td>
                <td class="col-md-3"><i class="fa fa-inr"></i>{{ $getdata->category->nama_kategori}}</td>
              </tr>
              <tr>
                <td class="col-md-9">Ruangan</td>
                <td class="col-md-3"><i class="fa fa-inr"></i>{{ $getdata->category->ruangan}}</td>
              </tr>
              <tr>
                <td class="col-md-9">Keluhan</td>
                <td class="col-md-3"><i class="fa fa-inr"></i>{{ $getdata->keluham}}</td>
              </tr>
              <tr>
                <td class="text-right">
                  <p>
