<head>
    ...
    <link rel="stylesheet" href="{{asset('dinda/vendors/select2/select2.min.css')}}">
    <link rel="stylesheet" href="{{asset('dinda/vendors/select2-bootstrap-theme/select2-bootstrap.min.css')}}">
