    ...
    <title>Aplikasi Pendaftaran Berobat Pada Puskesmas</title>
    ...
    <link rel="shortcut icon" href="{{ asset ('assets/images/pertamina.png') }}" type="image/x-icon">

    <link rel="stylesheet" href="{{ asset ('assets/vendors/bootstrap-icons/bootstrap-icons.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset ('assets/css/app.css') }}">
    <!-- <link rel="shortcut icon" href="{{ asset ('assets/images/logo/ptpt.png') }}" type="image/x-icon"> -->
